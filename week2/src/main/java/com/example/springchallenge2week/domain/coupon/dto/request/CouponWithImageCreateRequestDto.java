...
@NoArgsConstructor
@ToString
public class CouponWithImageCreateRequestDto {
    ...
    @Builder
    public CouponWithImageCreateRequestDto(String name, String code, CouponType type, CouponStatus status, LocalDate startDate, LocalDate endDate) {
        this.name = name;
        this.code = code;
        this.type = type;
        this.status = status;
